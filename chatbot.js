  ...
  function injectStyles() {
    ...
    style.textContent =
      ':root{' +
        '--ca-teal:#0CC9A8;' +
        '--ca-panel-bg:#0A1628;' +
        '--ca-font:var(--font-body,"Inter","DM Sans",Arial,sans-serif);' +
      '}' +
      ...
      '#ca-chatbot-btn{' +
        ...
        'background:var(--ca-teal);color:#fff;cursor:pointer;' +
      ...
      '}' +
      '.ca-msg-user{align-self:flex-end;background:var(--ca-teal);color:#fff;border-bottom-right-radius:4px;}' +
