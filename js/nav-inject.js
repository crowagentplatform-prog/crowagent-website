...
(function () {
  ...
  var NAV_HTML = [
    ...
    '      <a class="btn-teal-sm nav-cta" href="https://app.crowagent.ai/signup?plan=core_starter" style="flex-shrink:0;white-space:nowrap;">Get started</a>',
    '    </div>',
    ...
    '  <a class="btn-teal-sm" href="https://app.crowagent.ai/signup?plan=core_starter">Get started</a>',
  ...
  var FOOTER_HTML = [
    ...
    '          <a href="/pricing">Pricing</a>',
    '          <a href="https://app.crowagent.ai/signup?plan=core_starter">Start free trial</a>',
